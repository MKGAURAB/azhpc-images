...
if [ "$GPU" = "NVIDIA" ]; then
    ...
    # Install RCCL (AMD ROCm Collective Communications Library)
...
# Install Azure/NHC Health Checks (GPU-specific)
...
[[ -f /opt/azurehpc/component_versions.txt ]] && cat /opt/azurehpc/component_versions.txt
echo "=========================================="
