...
# =============================================================================
# Finalization: AlmaLinux 9.7
# =============================================================================
# Runs final yum update, cleans artifacts, executes Trivy, and disables cloud-init.
# =============================================================================

echo "=========================================="
echo "Finalization: Cleanup and Security (AlmaLinux 9.7)"
echo "=========================================="
...
if command -v yum >/dev/null 2>&1; then
    echo "Applying final yum update..."
    yum update -y || true
fi
